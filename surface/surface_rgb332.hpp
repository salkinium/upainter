...
class Surface<Width, Height, PixelFormat::RGB332> : public PixelBuffer
{
public:
...
public:
	Surface() :
		PixelBuffer(reinterpret_cast<uint8_t*>(buffer[0][0]), Width, Height, PixelFormat::RGB332),
		buffer{{0}}
	{}
	...
	{ return PixelBuffer(&buffer[0][0], Width, Height, PixelFormat::RGB332); }
